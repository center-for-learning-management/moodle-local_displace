...
$string['displace:admin_user_viewtable'] = 'Capability to view the user table';
...
$string['notifications:setting:enabled'] = 'Enable this displacement';

$string['pluginname'] = 'Displace';
$string['privacy:metadata'] = 'No personal data is stored with this plugin.';

$string['question:setting'] = 'Question Bank';
$string['question:setting:description'] = 'Displace the question bank';
$string['question:setting:enabled'] = 'Enable this displacement';
